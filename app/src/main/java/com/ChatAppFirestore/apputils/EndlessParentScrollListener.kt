...
abstract class EndlessParentScrollListener(internal var mLayoutManager: RecyclerView.LayoutManager) : NestedScrollView.OnScrollChangeListener {
    ...
    override fun onScrollChange(scrollView: NestedScrollView,x: Int,y: Int,oldx: Int,oldy: Int) {
        ...
        val distanceToEnd = view.bottom - (scrollView.height + scrollView.scrollY)
