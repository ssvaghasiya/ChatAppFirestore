...
class AsyncProgressDialog : Thread {
    ...
    constructor(context: Activity) {
        ...
        pd!!.setContentView(
                ...
                ViewGroup.LayoutParams(Utils.getDeviceWidth(context), Utils.getDeviceHeight(context)))
    }
    ...
    companion object {
        ...
        fun getInstant(context: Activity): AsyncProgressDialog {
            return AsyncProgressDialog(context)
        }

        fun getInstant(context: Activity, msg: String): AsyncProgressDialog {
            return AsyncProgressDialog(context, msg)
        }
    }
